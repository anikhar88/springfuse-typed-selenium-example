...
import fr.vendredi.repository.more.MoreTypesDemoGenerator;
import fr.vendredi.dao.more.MoreTypesDemoDao;

/**
 * Integration test on MoreTypesDemoDao
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = { "classpath*:spring/applicationContext-test.xml" })
@Transactional
public class MoreTypesDemoDaoIT {
    @SuppressWarnings("unused")
    private static final Logger log = LoggerFactory.getLogger(MoreTypesDemoDaoIT.class);
